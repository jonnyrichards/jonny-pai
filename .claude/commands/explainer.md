...
2. **Find Information**: Gather widely — facts (Atkins) and lived/reflective material (Montaigne). If a notes vault is configured (`PAI_NOTES_VAULT`), search it for relevant source material.
